...
<div class="space-y-6">
    ...
    <form method="POST" action="<?php echo e(route('settings.update')); ?>" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="card p-6 space-y-4">
            ...
            <div x-data="qrisUploadForm('<?php echo e($qrisUrl); ?>')" class="space-y-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="bank_name"
                           value="<?php echo e(old('bank_name', $settings['bank_name'] ?? null)); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="bank_account"
                           value="<?php echo e(old('bank_account', $settings['bank_account'] ?? null)); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="bank_holder"
                           value="<?php echo e(old('bank_holder', $settings['bank_holder'] ?? null)); ?>"
        ...
        <div class="card p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="company_tagline"
                           value="<?php echo e(old('company_tagline', $settings['company_tagline'] ?? null)); ?>"
            ...
            <div>
                ...
                <textarea name="company_address" rows="2" class="form-input resize-none"
                           placeholder="Alamat lengkap perusahaan"><?php echo e(old('company_address', $settings['company_address'] ?? null)); ?></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="company_website"
                           value="<?php echo e(old('company_website', $settings['company_website'] ?? null)); ?>"
        ...
        <div class="card p-6 space-y-4">
            ...
            <div x-data="imageUploadForm('<?php echo e($appLogoUrl); ?>')" class="space-y-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div>
                    ...
                    <input type="text" name="app_name"
                           value="<?php echo e(old('app_name', $settings['app_name'] ?? null)); ?>"
                           class="form-input" placeholder="Contoh: SewaJas">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1.5" style="color:var(--text-dark)">Tagline</label>
                    <input type="text" name="app_tagline"
                           value="<?php echo e(old('app_tagline', $settings['app_tagline'] ?? null)); ?>"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="fine_per_day" min="0" step="1"
                           value="<?php echo e(old('fine_per_day', $settings['fine_per_day'] ?? 0)); ?>"
                ...
                <div>
                    ...
                    <input type="number" name="rental_duration_days" min="0" step="1"
                           value="<?php echo e(old('rental_duration_days', $settings['rental_duration_days'] ?? 3)); ?>"
                           class="form-input" required>
                </div>
            </div>
        </div>
