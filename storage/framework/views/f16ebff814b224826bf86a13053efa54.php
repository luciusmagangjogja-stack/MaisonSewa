...
<head>
    ...
    <meta name="description" content="Login <?php echo e($appName); ?> - <?php echo e($appTagline); ?>" />
    <meta property="og:title" content="<?php echo e($appName); ?>" />
    <meta property="og:description" content="<?php echo e($appTagline); ?>" />
    ...
    <div class="lg:hidden fixed top-0 inset-x-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div class="flex items-center justify-between px-4 py-3">
                <div class="flex items-center gap-2">
                    <?php if($appLogoUrl): ?>
                        <img src="<?php echo e($appLogoUrl); ?>" alt="<?php echo e($appName); ?> Logo" class="h-10 w-10 rounded-xl object-contain">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div>
                    <div class="font-extrabold leading-none"><?php echo e($appName); ?></div>
                    <div class="text-[10px] font-semibold uppercase tracking-widest text-slate-500 leading-none mt-1"><?php echo e($appTagline); ?></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="relative z-10 flex flex-col justify-center w-full px-10 py-12 text-white">
                <div class="max-w-md">
                    <div class="flex items-center gap-3">
                        <?php if($appLogoUrl): ?>
                            <img src="<?php echo e($appLogoUrl); ?>" alt="<?php echo e($appName); ?> Logo" class="h-12 w-12 rounded-2xl object-contain">
                        <?php else: ?>
                        ...
                        <div>
                            ...
                            <div class="text-sm font-semibold text-white/80"><?php echo e($appTagline); ?></div>
                        </div>
                    </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-3xl shadow-card border border-slate-200 overflow-hidden">
                        ...
                        <div class="flex items-center gap-3">
                            <?php if($appLogo && \Illuminate\Support\Facades\Storage::disk('public')->exists($appLogo)): ?>
                                <?php
                                    ...
                                    $appLogoUrl = 'data:image/' . $extension . ';base64,' . base64_encode(file_get_contents($fullPath));
                                ?>
                                <img src="<?php echo e($appLogoUrl); ?>" alt="<?php echo e($appName); ?> Logo" class="h-11 w-11 rounded-2xl object-contain">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <div class="text-xs font-bold uppercase tracking-widest text-blue-700"><?php echo e($appName); ?> Login</div>
                    ...
                    <div class="px-6 sm:px-7 py-6">
                        ...
                        <form method="POST" action="<?php echo e(route('login.post')); ?>" @submit="loading = true" class="space-y-4" x-ref="loginForm">
                            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="mt-2 text-xs font-semibold text-red-600"><?php echo e($message); ?></div>
                                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center gap-2 text-sm text-slate-600 select-none">
                                    <input type="checkbox" id="remember" name="remember" class="h-4 w-4 rounded border-slate-300 text-blue-600 focus:ring-blue-600/20" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                    Ingat saya
                                </label>
                            </div>
                        ...
                        <?php if(app()->environment('local')): ?>
                            <div class="mt-6">
                                ...
                                <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <?php $__currentLoopData = [
                                    ...
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$role, $email]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button
                                            type="button"
                                        ...
                                        >
                                            <div class="text-[11px] font-extrabold text-slate-800"><?php echo e($role); ?></div>
                                            <div class="text-[10px] mt-1 text-slate-500 truncate"><?php echo e($email); ?></div>
                                        </button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                    ...
                    <div class="px-6 sm:px-7 pb-7">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            <div class="text-xs text-slate-500 font-semibold">© <?php echo e(date('Y')); ?> <?php echo e($appName); ?></div>
                            <div class="text-xs text-slate-400"><?php echo e($appTagline); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp82\htdocs\rental-jas-main\resources\views/auth/login.blade.php ENDPATH**/ ?>