...
<?php $__env->startSection('title', 'Buat Penyewaan'); ?>
<?php $__env->startSection('page-title', 'Buat Penyewaan'); ?>
...
<div class="max-w-4xl mx-auto space-y-5">
    <div class="flex items-center gap-3 mb-5">
        ...
        <form method="POST" action="<?php echo e(route('rentals.store')); ?>" enctype="multipart/form-data" x-data="rentalForm()" @submit.prevent="submitForm()" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="rental_date" value="<?php echo e(old('rental_date', now()->format('Y-m-d'))); ?>" class="form-input" @input="rentalDateError = false">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="duration_days" value="<?php echo e(old('duration_days', 1)); ?>" min="1" class="form-input" @input="durationDaysError = false">
                    ...
                    <div class="flex gap-3 items-center flex-wrap">
                        <select x-model="item.product_id" :name="`items[${index}][product_id]`" class="form-input flex-1" :class="{ 'is-error': itemsErrors[index]?.product_id || itemsErrors[index]?.stock_exceeded }" @change="onProductChange(index)">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($product->id); ?>" data-price="<?php echo e($product->rental_price); ?>" data-deposit-price="<?php echo e($product->deposit_price); ?>" data-stock="<?php echo e($product->stock_available); ?>"><?php echo e($product->name); ?> (Stok: <?php echo e($product->stock_available); ?>) - Rp <?php echo e(number_format($product->rental_price, 0, ',', '.')); ?>/hari</option>
        ...
        <div class="card p-6">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="discount" value="<?php echo e(old('discount', 0)); ?>" min="0" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="notes" class="form-input" rows="1"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="guarantee_type" class="form-input" @change="guaranteeTypeError = false" x-model="guaranteeType">
                        ...
                        <option value="ktp" <?php echo e(old('guarantee_type') === 'ktp' ? 'selected' : ''); ?>>KTP</option>
                        <option value="sim" <?php echo e(old('guarantee_type') === 'sim' ? 'selected' : ''); ?>>SIM</option>
                        <option value="deposit" <?php echo e(old('guarantee_type') === 'deposit' ? 'selected' : ''); ?>>Deposit Uang</option>
                        <option value="custom" <?php echo e(old('guarantee_type') === 'custom' ? 'selected' : ''); ?>>Jaminan Custom</option>
                    </select>
                    <?php $__errorArgs = ['guarantee_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-xs text-red-400 mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="hidden" name="guarantee_id_number" value="<?php echo e(old('guarantee_id_number', '')); ?>">
                </div>
...
<script>
    function rentalForm() {
        return {
            ...
            guaranteeType: '<?php echo e(old('guarantee_type', '')); ?>',
            guaranteeDeposit: '<?php echo e(old('guarantee_deposit', '')); ?>',
        ...
        customerSearch: <?php echo json_encode($oldCustomer ? $oldCustomer->name . ' - ' . $oldCustomer->phone : '', 15, 512) ?>,
        selectedCustomer: <?php echo json_encode($oldCustomer ? ['id' => $oldCustomer->id, 'name' => $oldCustomer->name, 'phone' => $oldCustomer->phone] : null) ?>,
...
<?php echo $__env->make('Layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\rental-jas-main\resources\views/rentals/create.blade.php ENDPATH**/ ?>