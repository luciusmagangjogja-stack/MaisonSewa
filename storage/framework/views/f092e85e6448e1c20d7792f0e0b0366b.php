...
<div id="dashboard-root" data-role="<?php echo e($role ?? ''); ?>" class="space-y-6">
    ...
    <div class="ds-card p-6">
        <div class="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div class="min-w-0">
                ...
                <h2 class="mt-3 text-2xl font-extrabold tracking-tight text-slate-950">
                    <?php echo e($greet); ?>, <?php echo e(auth()->user()->name); ?>

                </h2>

                <p class="mt-1 text-sm font-semibold text-slate-500">
                    <?php echo e($now->translatedFormat('l, d M Y')); ?> • <?php echo e($now->format('H:i')); ?> WIB
                </p>

                <?php if($role === 'admin_toko' || $role === 'sales'): ?>
                    <div class="mt-3 text-sm text-slate-600">
                        <span class="font-bold text-slate-900">Cabang:</span>
                        <span class="font-semibold"><?php echo e($branches[0]->name ?? ($data['branch_name'] ?? '-')); ?></span>
                    </div>
                <?php endif; ?>
            </div>
                ...
                <?php if($role !== 'sales'): ?>
                    <div class="flex items-center gap-2">
                        ...
                        <select id="filter-sales" class="px-3.5 py-2 rounded-2xl border border-slate-200 text-sm bg-white ds-transition">
                            ...
                            <?php $__currentLoopData = $sales ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($salesUser->id); ?>"><?php echo e($salesUser->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                <?php endif; ?>
        ...
        <div class="mt-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <?php if($role === 'super_admin'): ?>
                    <a href="<?php echo e(route('branches.index')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="building-2" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Kelola Cabang</span>
                    </a>
                    <a href="<?php echo e(route('users.index')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="users" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Kelola Admin</span>
                    </a>
                    <a href="<?php echo e(route('broadcasts.index')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="send" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Broadcast</span>
                    </a>
                    <a href="<?php echo e(route('reports.revenue')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="trending-up" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Laporan</span>
                    </a>
                    <a href="<?php echo e(route('rentals.scan')); ?>" class="ds-hover-lift btn btn-secondary">
                ...
                <?php if($role === 'admin_toko'): ?>
                    <a href="<?php echo e(route('customers.index')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="user-plus" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Tambah Customer</span>
                    </a>
                    <a href="<?php echo e(route('rentals.create')); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="plus-circle" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Buat Sewa</span>
                    </a>
                    <a href="<?php echo e(route('rentals.index', ['status' => 'active'])); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="reply" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Pengembalian</span>
                    </a>
                    <a href="<?php echo e(route('rentals.index')); ?>" class="ds-hover-lift btn btn-secondary">
                ...
                <?php if($role === 'sales'): ?>
                    ...
                    <a href="<?php echo e(route('rentals.index', ['status' => 'overdue'])); ?>" class="ds-hover-lift btn btn-secondary">
                        <i data-lucide="reply" class="h-4 w-4 text-primary"></i>
                        <span class="font-bold">Pengembalian</span>
                    </a>
                    <a href="<?php echo e(route('reports.transactions')); ?>" class="ds-hover-lift btn btn-secondary">
            ...
            <div class="ds-card p-5 ds-transition ds-hover-lift group relative overflow-hidden">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-xs font-extrabold uppercase tracking-widest text-slate-500"><?php echo e($c['label']); ?></div>
                        </div>
                        <div class="h-11 w-11 rounded-2xl flex items-center justify-center text-white" style="background: linear-gradient(135deg, #2563EB, #60A5FA);">
                            <i data-lucide="<?php echo e($c['icon']); ?>" class="h-5 w-5"></i>
                        </div>
                    </div>

                    <div class="mt-4">
                        <div class="text-3xl font-extrabold tracking-tight text-slate-950" data-stat="<?php echo e($c['stat']); ?>">—</div>
                        <div class="mt-1 text-sm font-semibold text-slate-500">
                            <?php if($c['subKey']): ?>
                                <span class="text-slate-900" data-stat="<?php echo e($c['subKey']); ?>">—</span>
                            <?php endif; ?>
                            <span class="<?php echo e($c['subKey'] ? 'ml-1' : ''); ?>"><?php echo e($c['sub']); ?></span>
                        </div>
                        <?php if($c['stat']==='penyewaan_minggu_ini'): ?>
                            <div class="mt-3">
    ...
    <div class="hidden" id="dashboard-empty" aria-live="polite">
        <div class="ds-card py-12">
            <div class="flex flex-col items-center justify-center text-center gap-2">
                ...
                <a href="<?php echo e(route('rentals.scan')); ?>" class="mt-3 ds-hover-lift btn btn-primary">
...
<script>
    ...
    async function fetchDashboardData() {
        ...
        const url = '<?php echo e(route('dashboard.data')); ?>' + (params.toString() ? '?' + params.toString() : '');
...
<?php /**PATH C:\xampp82\htdocs\rental-jas-main\resources\views/dashboard/_dashboard_common.blade.php ENDPATH**/ ?>